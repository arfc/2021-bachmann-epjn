...
in the no growth and 1\% growth scenarios, respectively. When the cumulative uranium 
masses in each scenario are compared, Figure \ref{fig:cumulativeU_all}, it is clear 
that deploying the \gls{MMR} will require more uranium than deploying the Xe-100 
reactor for the same transition scenario. 
...
\begin{figure}
    \centering 
    \includegraphics[scale=0.5]{../figures/fuelsupplytotal_scenarios_all.png}
    \caption{}
