...
recipes for spent and fresh \gls{LWR} 
...
This work did not include neutronic or depletion simulations to determine 
any material compositions.   
The enrichment facility assumes the feed material is natural uranium, 
