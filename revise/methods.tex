...
decommission 
date for any reactor closed before December 2020. Any \gls{LWR} still in 
operation in December 2020 is assumed to operate for 60 years after its 
grid connection date. The simulations do not consider research or 
...
a power output of 40 MWth, and a cycle length of 2,042 \gls{EFPD} \cite{venneri_neutronic_2015}
...
kernell in a fuel pebble and the number of 
...
recognizing each facility deployed how each it contributes 
