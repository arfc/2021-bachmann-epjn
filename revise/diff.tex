...
%DIF DEL ../main.tex     Fri Sep 17 15:13:05 2021
%DIF ADD revisions.tex   Fri Sep 17 15:28:51 2021
...
for advanced
reactors : enriching natural uranium and downblending high-enriched uranium}\DIFdelend \DIFaddbegin \DIFadd{Transitioning to High Assay Low Enriched Uranium-fueled reactors will
alter the material requirements of the current nuclear fuel cycle, in 
terms of the mass of enriched uranium and Separative Work Unit capacity}\DIFaddend .  
To understand the material requirements of \DIFdelbegin \DIFdel{enriching natural uranium to produce \mbox{%DIFAUXCMD
\gls{HALEU}}\hspace{0pt}%DIFAUXCMD
, }\DIFdelend \DIFaddbegin \DIFadd{transitioning to High Assay 
Low Enriched Uranium-fueled advanced reactors }\DIFaddend this 
work simulates multiple fuel cycle scenarios to compare how the \DIFdelbegin \DIFdel{size }\DIFdelend \DIFaddbegin \DIFadd{type }\DIFaddend of the
...
either \DIFdelbegin \DIFdel{a microreactor fleet or a small modular reactor fleet }\DIFdelend \DIFaddbegin \DIFadd{the Ultra Safe Nuclear Corporation \mbox{%DIFAUXCMD
\gls{MMR} }\hspace{0pt}%DIFAUXCMD
or the X-energy Xe-100
}\DIFaddend from the current fleet of Light Water Reactors \DIFdelbegin \DIFdel{.The Ultra Safe Nuclear Corporation 
\mbox{%DIFAUXCMD
\gls{MMR} }\hspace{0pt}%DIFAUXCMD
and X-energy Xe-100 were chosen to represent the microreactor 
and small modular reactors, respectively.}\DIFdelend \DIFaddbegin \DIFadd{in the U.S. }\DIFaddend Materials of interest include 
the number of 
...
\DIFdelbegin \DIFdel{This work shows that deploying }\DIFdelend \DIFaddbegin \DIFadd{Deploying }\DIFaddend the \gls{MMR} requires a higher 
...
}\DIFdelend \DIFaddbegin \DIFadd{before 2025. Fueling the Xe-100 reactors requires less 
...
\gls{NU} }\hspace{0pt}%DIFAUXCMD
is limited by the amount of }\DIFdelend \DIFaddbegin \DIFadd{The mass of }\DIFaddend uranium that can be mined and the \gls{SWU} capacity \DIFdelbegin \DIFdel{to enrich the uranium}\DIFdelend \DIFaddbegin \DIFadd{available 
to enrich natural uranium limits the mass of enriched uranium that can be 
...
\DIFdelbegin \DIFdel{how the production method affects the }\DIFdelend \DIFaddbegin \DIFadd{the }\DIFaddend rate of reactor deployment.
...
}\DIFdelend \DIFaddbegin \DIFadd{supplied
}\DIFaddend data about the currently deployed \glspl{LWR}. This database provides the 
...
\DIFdelbegin \DIFdel{. Only reactorswith a power 
...
pebbles for the }\DIFaddend Xe-100 
reactor \DIFdelbegin \DIFdel{has a much higher }\DIFdelend \DIFaddbegin \DIFadd{was found by calculating the total volume of UCO \mbox{%DIFAUXCMD
\gls{TRISO} 
}\hspace{0pt}%DIFAUXCMD
...
\DIFadd{The Xe-100 reactor has a greater }\DIFaddend power output, requires a higher enrichment 
...
disposal of the fuel in the \DIFdelbegin \DIFdel{HLW }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
...
\DIFdelbegin \DIFdel{Material compositions are defined using recipes. Spent }\DIFdelend \DIFaddbegin \DIFadd{Recipes define the composition of the materials shown in Figure 
\ref{fig:fuel_cycle}. Yacout et al. \mbox{%DIFAUXCMD
\cite{yacout_visionverifiable_2006}
}\hspace{0pt}%DIFAUXCMD
recipes for spent }\DIFaddend and fresh \gls{LWR} 
\DIFdelbegin \DIFdel{fuel recipes were obtained from \mbox{%DIFAUXCMD
\cite{yacout_visionverifiable_2006}}\hspace{0pt}%DIFAUXCMD
. 
The spent \mbox{%DIFAUXCMD
\gls{LWR} }\hspace{0pt}%DIFAUXCMD
fuel 
recipe assumes }\DIFdelend \DIFaddbegin \DIFadd{assuming }\DIFaddend a 51 MWd/kg-U burnup. All other recipes capture the 
...
\DIFdelbegin \DIFdel{The enrichment feed recipe assumes natural uranium is used}\DIFdelend \DIFaddbegin \DIFadd{This work did not include neutronic or depletion simualtions to determine 
any material compositions.   
The enrichment facility assumes the feed material is natural uranium}\DIFaddend , 
...
is deployed it is deployed }\DIFdelend \DIFaddbegin \DIFadd{New reactors 
are deployed }\DIFaddend with an entire core of uranium\DIFdelbegin \DIFdel{which leads 
...
than the
}\DIFaddend average mass sent to the \glspl{LWR}. The \DIFdelbegin \DIFdel{lower average is explained by the 
multiple time periods in 
which no \mbox{%DIFAUXCMD
\gls{HALEU} }\hspace{0pt}%DIFAUXCMD
is sent to the \mbox{%DIFAUXCMD
\glspl{MMR} }\hspace{0pt}%DIFAUXCMD
due to the lack of refueling. }\DIFdelend \DIFaddbegin \DIFadd{smaller average is because of the 
...
a }\DIFdelend \DIFaddbegin \DIFadd{uranium at a }\DIFaddend higher enrichment 
...
Scenario 2. \DIFaddbegin \DIFadd{A total of 58,410.1 MTU and 27,775.1 MTU are sent to 
...
Scenario 2. The average is slightly \DIFdelbegin \DIFdel{higher }\DIFdelend \DIFaddbegin \DIFadd{greater }\DIFaddend than the average \gls{SWU} 
capacity required to enrich uranium for the \glspl{LWR} before 2025 in 
Scenario 1. \DIFaddbegin \DIFadd{A total of 25.5$\times 10^8$ kg-SWU and 23.1$\times 10^8$
...
\DIFdel{This work }\DIFdelend \DIFaddbegin \subsection{\DIFadd{Scenario comparisons}}
...
a large mass of urnaium (more than 200 MTU) are sent to the \mbox{%DIFAUXCMD
\glspl{MMR}}\hspace{0pt}%DIFAUXCMD
. 
...
site. This theoretical example shows how a constant-capacity \mbox{%DIFAUXCMD
\gls{HALEU} }\hspace{0pt}%DIFAUXCMD
enrichment 
...
\DIFadd{This work }\DIFaddend simulated multiple fuel cycle scenarios to compare the 
...
also simulated }\DIFdelend \DIFaddbegin \DIFadd{was 
also simulated for comparison}\DIFaddend . Each of these scenarios are compared 
for their material 
...
in the transitions to the }\DIFdelend \DIFaddbegin \DIFadd{requires a smaller average 
...
fueling the }\DIFaddend Xe-100 \DIFdelbegin \DIFdel{reactor because this reactor utilizes 
...
%DIFDELCMD <   \def\url#1{\texttt{#1}}\fi
%DIFDELCMD < \expandafter\ifx\csname %%%
\DIFdel{urlprefix}%DIFDELCMD < \endcsname\relax\def\urlprefix{URL }\fi
%DIFDELCMD < \expandafter\ifx\csname %%%
\DIFdel{href}%DIFDELCMD < \endcsname\relax
%DIFDELCMD <   \def\href#1#2{#2} \def\path#1{#1}\fi
%DIFDELCMD < 

%DIFDELCMD < \bibitem{wigeland_nuclear_2014}
\DIFdel{R.~Wigeland, T.~Taiwo, H.~Ludewig, M.~Todosow, W.~Halsey, J.~Gehin, R.~Jubin,
  J.~Buelt, S.~Stockinger, K.~Jenni, B.~Oakley,
  }\href{https://fuelcycleevaluation.inl.gov}{\DIFdel{Nuclear }%DIFDELCMD < {%%%
\DIFdel{Fuel}%DIFDELCMD < } {%%%
\DIFdel{Cycle}%DIFDELCMD < }
%DIFDELCMD <   {%%%
\DIFdel{Evaluation}%DIFDELCMD < } %%%
\DIFdel{and }%DIFDELCMD < {%%%
\DIFdel{Screening}%DIFDELCMD < } %%%
\DIFdel{-- }%DIFDELCMD < {%%%
\DIFdel{Final}%DIFDELCMD < } {%%%
\DIFdel{Report}%DIFDELCMD < }%%%
}%DIFAUXCMD
\DIFdel{, Tech. Rep.
...
%DIFDELCMD < \bibitem{burns_reactor_2020}
\DIFdel{J.~R. Burns, R.~Hernandez, K.~A. Terrani, A.~T. Nelson, N.~R. Brown,
  ...
  and fuel cycle performance of light water reactor fuel with }%DIFDELCMD < {%%%
\DIFdel{235U}%DIFDELCMD < }
%DIFDELCMD <   %%%
\DIFdel{enrichments above 5\%}}%DIFAUXCMD
\DIFdel{, Annals of Nuclear Energy 142 (2020) 107423.
}%DIFDELCMD < \newblock %%%
\href {http://dx.doi.org/10.1016/j.anucene.2020.107423}
  {%DIFDELCMD < \path{doi:10.1016/j.anucene.2020.107423}%%%
}%DIFAUXCMD
\DIFdel{.
}%DIFDELCMD < \newline\urlprefix\url{https://www.sciencedirect.com/science/article/pii/S0306454920301213}
%DIFDELCMD < 

%DIFDELCMD < \bibitem{hernandez_potential_2020}
...
\DIFdel{K.~D. Huff, M.~J. Gidden, R.~W. Carlsen, R.~R. Flanagan, M.~B. McGarry, A.~C.
  ...
  concepts in the }%DIFDELCMD < {%%%
\DIFdel{Cyclus}%DIFDELCMD < } %%%
\DIFdel{nuclear fuel cycle simulation framework}}%DIFAUXCMD
\DIFdel{, Advances
  in Engineering Software 94 (2016) 46--59, arXiv: 1509.03604.
}%DIFDELCMD < \newblock %%%
\href {http://dx.doi.org/10.1016/j.advengsoft.2016.01.014}
  {%DIFDELCMD < \path{doi:10.1016/j.advengsoft.2016.01.014}%%%
}%DIFAUXCMD
\DIFdel{.
}%DIFDELCMD < \newline\urlprefix\url{http://www.sciencedirect.com/science/article/pii/S0965997816300229}
%DIFDELCMD < 

%DIFDELCMD < \bibitem{noauthor_power_1989}
\href{https://www.iaea.org/publications/762/power-reactor-information-system-pris-reference-and-on-line-access-manual}{\DIFdel{Power
  }%DIFDELCMD < {%%%
\DIFdel{Reactor}%DIFDELCMD < } {%%%
\DIFdel{Information}%DIFDELCMD < } {%%%
\DIFdel{System}%DIFDELCMD < } %%%
\DIFdel{(}%DIFDELCMD < {%%%
\DIFdel{PRIS}%DIFDELCMD < }%%%
\DIFdel{): }%DIFDELCMD < {%%%
\DIFdel{Reference}%DIFDELCMD < } %%%
\DIFdel{and }%DIFDELCMD < {%%%
\DIFdel{On}%DIFDELCMD < }%%%
\DIFdel{-line }%DIFDELCMD < {%%%
\DIFdel{Access}%DIFDELCMD < }
%DIFDELCMD <   {%%%
\DIFdel{Manual}%DIFDELCMD < }%%%
}%DIFAUXCMD
\DIFdel{, no. 507 in }%DIFDELCMD < {%%%
...
%DIFDELCMD < \bibitem{todreas_nuclear_2012}
\DIFdel{N.~E. Todreas, Nuclear systems, 2nd Edition, Taylor \& Francis, Boca Raton, FL,
  2012.
}%DIFDELCMD < 

%DIFDELCMD < \bibitem{cacuci_handbook_2010}
\DIFdel{D.~G. Cacuci, Handbook of nuclear engineering, Springer, New York ;, 2010.
}%DIFDELCMD < 

%DIFDELCMD < \bibitem{mitchell_usnc_2020}
\DIFdel{M.~Mitchell,
  }\href{https://gain.inl.gov/HALEU_Webinar_Presentations/33-Mitchell,Ultrasafe_Rev02-29apr2020.pdf}{%DIFDELCMD < {%%%
\DIFdel{USNC}%DIFDELCMD < }
%DIFDELCMD <   {%%%
\DIFdel{Micro}%DIFDELCMD < } {%%%
\DIFdel{Modular}%DIFDELCMD < } {%%%
\DIFdel{Reactor}%DIFDELCMD < } %%%
\DIFdel{– }%DIFDELCMD < {%%%
\DIFdel{Project}%DIFDELCMD < } %%%
\DIFdel{and }%DIFDELCMD < {%%%
\DIFdel{Fuel}%DIFDELCMD < }%%%
} %DIFAUXCMD
\DIFdel{(Apr. 2020).
...
%DIFDELCMD < \bibitem{harlan_x-energy_2018}
\DIFdel{B.~Harlan,
  }\href{https://adamswebsearch2.nrc.gov/webSearch2/main.jsp?AccessionNumber=ML18253A109}{\DIFdel{X-energy
  }%DIFDELCMD < {%%%
\DIFdel{Xe}%DIFDELCMD < }%%%
\DIFdel{-100 }%DIFDELCMD < {%%%
\DIFdel{Reactor}%DIFDELCMD < } %%%
\DIFdel{initial }%DIFDELCMD < {%%%
\DIFdel{NRC}%DIFDELCMD < } %%%
\DIFdel{meeting}} %DIFAUXCMD
\DIFdel{(Sep. 2018).
}%DIFDELCMD < \newline\urlprefix\url{https://adamswebsearch2.nrc.gov/webSearch2/main.jsp?AccessionNumber=ML18253A109}
%DIFDELCMD < 

%DIFDELCMD < \bibitem{hussain_advances_2018}
\DIFdel{M.~Hussain, F.~Reitsma, M.~Subki, H.~Kiuchi,
  }\href{http://aris.iaea.org}{\DIFdel{Advances in }%DIFDELCMD < {%%%
\DIFdel{Small}%DIFDELCMD < } {%%%
\DIFdel{Modular}%DIFDELCMD < } {%%%
\DIFdel{Reactor}%DIFDELCMD < }
%DIFDELCMD <   {%%%
\DIFdel{Technology}%DIFDELCMD < } {%%%
\DIFdel{Developments}%DIFDELCMD < }%%%
}%DIFAUXCMD
\DIFdel{, A }%DIFDELCMD < {%%%
\DIFdel{Supplement}%DIFDELCMD < } %%%
\DIFdel{to: }%DIFDELCMD < {%%%
\DIFdel{IAEA}%DIFDELCMD < } {%%%
\DIFdel{Advanced}%DIFDELCMD < } {%%%
\DIFdel{Reactors}%DIFDELCMD < }
%DIFDELCMD <   {%%%
\DIFdel{Information}%DIFDELCMD < } {%%%
\DIFdel{System}%DIFDELCMD < } %%%
\DIFdel{(}%DIFDELCMD < {%%%
\DIFdel{ARIS}%DIFDELCMD < }%%%
...
%DIFDELCMD < \bibitem{yacout_visionverifiable_2006}
\DIFdel{A.~Yacout, J.~Jacobson, G.~Matthern, S.~Piet, D.~Shropshire, C.~Laws,
  }%DIFDELCMD < {%%%
\DIFdel{VISION}%DIFDELCMD < }%%%
\DIFdel{–}%DIFDELCMD < {%%%
\DIFdel{Verifiable}%DIFDELCMD < } {%%%
\DIFdel{Fuel}%DIFDELCMD < } {%%%
\DIFdel{Cycle}%DIFDELCMD < } {%%%
\DIFdel{Simulation}%DIFDELCMD < } %%%
\DIFdel{of }%DIFDELCMD < {%%%
\DIFdel{Nuclear}%DIFDELCMD < } {%%%
\DIFdel{Fuel}%DIFDELCMD < }
%DIFDELCMD <   {%%%
\DIFdel{Cycle}%DIFDELCMD < } {%%%
\DIFdel{Dynamics}%DIFDELCMD < }%%%
