...
fleet }\DIFdelend \DIFaddbegin \DIFadd{the Ultra Safe Nuclear Corporation \mbox{%DIFAUXCMD
...
recipes for spent and fresh \mbox{%DIFAUXCMD
\gls{LWR} 
}\hspace{0pt}%DIFAUXCMD
...
\DIFdelbegin \DIFdel{The enrichment feed recipe assumes natural uranium is used}\DIFdelend \DIFaddbegin \DIFadd{This work did not include neutronic or depletion simulations to determine 
...
%\DIFdel{#2}%DIFDELCMD < } \def\path%%%
%\DIFdel{#1}%DIFDELCMD < {%%%
%\DIFdel{#1}%DIFDELCMD < }\fi
%DIFDELCMD < 
...
\DIFdel{R.~Wigeland, T.~Taiwo, H.~Ludewig, M.~Todosow, W.~Halsey, J.~Gehin, R.~Jubin,
  ...
  }%DIFDELCMD < \href{https://fuelcycleevaluation.inl.gov}{Nuclear {Fuel} {Cycle}
%DIFDELCMD <   {Evaluation} and {Screening} -- {Final} {Report}}%%%
\DIFdel{, Tech. Rep.
...
\DIFdel{J.~R. Burns, R.~Hernandez, K.~A. Terrani, A.~T. Nelson, N.~R. Brown,
  }%DIFDELCMD < \href{https://www.sciencedirect.com/science/article/pii/S0306454920301213}{Reactor
%DIFDELCMD <   and fuel cycle performance of light water reactor fuel with {235U}
%DIFDELCMD <   enrichments above 5\%}%%%
\DIFdel{, Annals of Nuclear Energy 142 (2020) 107423.
}%DIFDELCMD < \newblock \href {%%%
\DIFdel{http://dx.doi.org/10.1016/j.anucene.2020.107423}%DIFDELCMD < }
...
\DIFdel{R.~Hernandez, N.~R. Brown,
  }%DIFDELCMD < \href{http://www.sciencedirect.com/science/article/pii/S030645492030253X}{Potential
%DIFDELCMD <   fuel cycle performance of floating small modular light water reactors of
%DIFDELCMD <   {Russian} origin}%%%
\DIFdel{, Annals of Nuclear Energy 144 (2020) 107555.
}%DIFDELCMD < \newblock \href {%%%
\DIFdel{http://dx.doi.org/10.1016/j.anucene.2020.107555}%DIFDELCMD < }
...
\DIFdel{K.~D. Huff, M.~J. Gidden, R.~W. Carlsen, R.~R. Flanagan, M.~B. McGarry, A.~C.
  ...
  }%DIFDELCMD < \href{http://www.sciencedirect.com/science/article/pii/S0965997816300229}{Fundamental
%DIFDELCMD <   concepts in the {Cyclus} nuclear fuel cycle simulation framework}%%%
\DIFdel{, Advances
  in Engineering Software 94 (2016) 46--59, arXiv: 1509.03604.
}%DIFDELCMD < \newblock \href {%%%
\DIFdel{http://dx.doi.org/10.1016/j.advengsoft.2016.01.014}%DIFDELCMD < }
...
%DIFDELCMD < \href{https://www.iaea.org/publications/762/power-reactor-information-system-pris-reference-and-on-line-access-manual}{Power
%DIFDELCMD <   {Reactor} {Information} {System} ({PRIS}): {Reference} and {On}-line {Access}
%DIFDELCMD <   {Manual}}%%%
...
%DIFDELCMD < %%%
\DIFdel{M.~Mitchell,
  }%DIFDELCMD < \href{https://gain.inl.gov/HALEU_Webinar_Presentations/33-Mitchell,Ultrasafe_Rev02-29apr2020.pdf}{{USNC}
%DIFDELCMD <   {Micro} {Modular} {Reactor} – {Project} and {Fuel}} %%%
\DIFdel{(Apr. 2020).
...
%DIFDELCMD < %%%
\DIFdel{B.~Harlan,
  }%DIFDELCMD < \href{https://adamswebsearch2.nrc.gov/webSearch2/main.jsp?AccessionNumber=ML18253A109}{X-energy
%DIFDELCMD <   {Xe}-100 {Reactor} initial {NRC} meeting} %%%
\DIFdel{(Sep. 2018).
...
\DIFdel{M.~Hussain, F.~Reitsma, M.~Subki, H.~Kiuchi,
  }%DIFDELCMD < \href{http://aris.iaea.org}{Advances in {Small} {Modular} {Reactor}
%DIFDELCMD <   {Technology} {Developments}}%%%
\DIFdel{, A }%DIFDELCMD < {%%%
