...
meet the energy demand of the scenario between 203-2050, because the energy 
produced by 
...
which no \gls{HALEU} is sent to the \glspl{MMR} due to the lack of refuleing.  
...
capacity required to enrich uranium for the \glspl{LWR} in Scenario 1. 
