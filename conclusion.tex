...
The transition scenarios exhibit some discrepancies in  
energy demand and produced, localized to the beginning of the 
transition
...
The results of this work show that transitioning to the \gls{MMR} requires 
...
\section{Future Work}
One possible are of future work is extending the end date 
